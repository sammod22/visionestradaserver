...
deathSound0:setSource('/visionestradaserver/deathSound0.mp3'):setAutoPlay(false)
deathSound1:setSource('/visionestradaserver/deathSound1.mp3'):setAutoPlay(false)
deathSound2:setSource('/visionestradaserver/deathSound2.mp3'):setAutoPlay(false)
